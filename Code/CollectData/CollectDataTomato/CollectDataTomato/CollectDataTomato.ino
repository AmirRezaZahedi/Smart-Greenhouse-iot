// Data collection from the greenhouse environment Tomato
// Tomato
...
{ 
  while(!client.connected()) 
  {
      ...
      if(client.connect("ESPClient")) 
      {
          ...
          client.subscribe("soilMoistureTomato");
          client.subscribe("airHumidityTomato");
          client.subscribe("airTemperatureTomato");
...
void loop()
{
    ...
    client.publish("soilMoistureTomato", s);
    Serial.println("s = ");
    Serial.println(s);
    client.publish("airHumidityTomato", h);
    client.publish("airTemperatureTomato", t); 
